...
static inline bool ImNan(double val) { return ((((sizeof ((val) + (float)0) == sizeof (float) ? 'f' : sizeof ((val) + (double)0) == sizeof (double) ? 'd' : 'l') == 'f' ? _fdclass((float)(val)) :(sizeof ((val) + (float)0) == sizeof (float) ? 'f' : sizeof ((val) + (double)0) == sizeof (double) ? 'd' : 'l') == 'd' ? _dclass((double)(val)) : _ldclass((long double)(val)))) == 2); }
...
struct ImPlotAxis
{
    ...
    ImPlotAxis() {
        ...
        FitExtents.Min = ((double)((float)(1e+300 * 1e+300)));
        FitExtents.Max = -((double)((float)(1e+300 * 1e+300)));
        OrthoAxis = ((void*)0);
        ConstraintRange = ImPlotRange(-((float)(1e+300 * 1e+300)),((float)(1e+300 * 1e+300)));
        ConstraintZoom = ImPlotRange(2.2250738585072014e-308,((float)(1e+300 * 1e+300)));
